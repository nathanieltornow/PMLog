...
with open(result_file_path, 'r') as res_file:
    ...
    plt.plot([r[0] / 1000 for r in append_res], [r[1] for r in append_res],'o-', markersize=4, label='Append - Average', color='blue')
    ...
    plt.plot([r[0] / 1000 for r in read_res], [r[1] for r in read_res], 'v-', markersize=4, label='Read - Average', color='green')
